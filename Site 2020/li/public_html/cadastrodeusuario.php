...
<html>
    ...
    <body>
        <form action="processousuario.php" method="POST"></form>
        <div id="paii"> 
          <div id="cabeçalho">
...
?>
         ...
         <form method = "POST" action="processodecadastro.php">
        ...
        <input type="text" name="Datadenascimento"  placeholder="Digite a data de nascimento"><br><br>
